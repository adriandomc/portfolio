...
<ImageCarousel
	images={[
		{
			src: '/assets/blog/blogging-ios-app/clone-repo.png',
			alt: 'Cloning a new repository',
		},
		{
			src: '/assets/blog/blogging-ios-app/file-explorer.png',
			alt: 'Browsing the repository files in the app',
		},
		{
			src: '/assets/blog/blogging-ios-app/editor.png',
			alt: 'Editing a markdown file from the iPhone',
		},
	]}
	maxWidth="24rem"
	aspectRatio="9 / 19.5"

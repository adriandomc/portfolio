...
title: Dinotext
description: >-
  Dinotext is a markup language, inspired by Markdown, which is the engine
  powering my main website. It is currently in a very early stage, but I have
  plans to make it a more formal markup language with real-world applications.
tags:
  - PHP
featured: false
order: 8

...
<ImageCarousel
	images={[
		{ src: '/images/projects/all-in-one/1.png', alt: 'A timeline tracker designed to see the current stop the bus unit is currently on' },
		{ src: '/images/projects/all-in-one/2.png', alt: 'Map visualizer which is updated in real time, showing the unit position and stops marker' },
		{ src: '/images/projects/all-in-one/3.png', alt: 'A time report generated with every position of the bus during its journey' },
	]}
	aspectRatio="16 / 10"
	objectFit="contain"
>

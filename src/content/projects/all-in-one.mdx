...
description: >-
  A set of visualization tools developed for an All in One platform, for a
  company in the industry of personnel transportation, consisting of a timeline
  tracker, realtime unit tracker and a time report generator with geofences and
  stop markers.
tags:
  - PHP
  - jQuery
...
images:
  - src: /images/projects/all-in-one/1.png
    alt: >-
      A timeline tracker designed to see the current stop the bus unit is
      currently on
  - src: /images/projects/all-in-one/2.png
    alt: >-
      Map visualizer which is updated in real time, showing the unit position
      and stops marker
